...
pub const RESIZE_DISCRIMINATOR: u8 = 56;
...
pub struct Resize {
    ...
    pub payer: (solana_pubkey::Pubkey, bool),
...
pub struct ResizeBuilder {
    ...
    payer: Option<(solana_pubkey::Pubkey, bool)>,
...
impl ResizeBuilder {
    ...
    /// The recipient of the excess rent and authority if the authority account is not present
    #[inline(always)]
    pub fn payer(&mut self, payer: solana_pubkey::Pubkey, as_signer: bool) -> &mut Self {
...
pub struct ResizeCpiAccounts<'a, 'b> {
    ...
    /// The recipient of the excess rent and authority if the authority account is not present
    pub payer: (&'b solana_account_info::AccountInfo<'a>, bool),
    /// Owner of the asset for (p)NFTs, or mint authority for fungible assets, if different from the payer
...
struct ResizeCpiBuilderInstruction<'a, 'b> {
    ...
    payer: Option<(&'b solana_account_info::AccountInfo<'a>, bool)>,
    authority: Option<&'b solana_account_info::AccountInfo<'a>>,
