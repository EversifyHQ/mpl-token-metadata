...
pub const UPDATE_DISCRIMINATOR: u8 = 50;
...
impl Update {
    pub fn instruction(&self, args: UpdateInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(token) = self.token {
            accounts.push(solana_instruction::AccountMeta::new_readonly(token, false));
        } else {
            accounts.push(solana_instruction::AccountMeta::new_readonly(
                crate::TOKEN_METADATA_ID,
                false,
