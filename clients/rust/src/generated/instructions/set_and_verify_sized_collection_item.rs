...
pub const SET_AND_VERIFY_SIZED_COLLECTION_ITEM_DISCRIMINATOR: u8 = 32;
...
impl Default for SetAndVerifySizedCollectionItemInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct SetAndVerifySizedCollectionItemBuilder {
    ...
    collection_authority: Option<solana_pubkey::Pubkey>,
    payer: Option<solana_pubkey::Pubkey>,
    update_authority: Option<solana_pubkey::Pubkey>,
    collection_mint: Option<solana_pubkey::Pubkey>,
    collection: Option<solana_pubkey::Pubkey>,
    collection_master_edition_account: Option<solana_pubkey::Pubkey>,
    collection_authority_record: Option<solana_pubkey::Pubkey>,
...
impl SetAndVerifySizedCollectionItemBuilder {
    ...
    /// Mint of the Collection
    #[inline(always)]
    pub fn collection_mint(&mut self, collection_mint: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn collection_master_edition_account(
        &mut self,
        collection_master_edition_account: solana_pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct SetAndVerifySizedCollectionItemCpiAccounts<'a, 'b> {
    ...
    /// Collection Update authority
    pub collection_authority: &'b solana_account_info::AccountInfo<'a>,
    /// payer
    pub payer: &'b solana_account_info::AccountInfo<'a>,
    /// Update Authority of Collection NFT and NFT
    pub update_authority: &'b solana_account_info::AccountInfo<'a>,
    /// Mint of the Collection
    pub collection_mint: &'b solana_account_info::AccountInfo<'a>,
    /// Metadata Account of the Collection
    pub collection: &'b solana_account_info::AccountInfo<'a>,
    /// MasterEdition2 Account of the Collection Token
    pub collection_master_edition_account: &'b solana_account_info::AccountInfo<'a>,
    /// Collection Authority Record PDA
    pub collection_authority_record: Option<&'b solana_account_info::AccountInfo<'a>>,
}
...
impl<'a, 'b> SetAndVerifySizedCollectionItemCpiBuilder<'a, 'b> {
    ...
    pub fn collection_authority(
        &mut self,
        collection_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn collection_mint(
        &mut self,
        collection_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn collection_master_edition_account(
        &mut self,
        collection_master_edition_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn collection_authority_record(
        &mut self,
        collection_authority_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    ) -> &mut Self {
...
struct SetAndVerifySizedCollectionItemCpiBuilderInstruction<'a, 'b> {
    ...
    collection_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
    payer: Option<&'b solana_account_info::AccountInfo<'a>>,
    update_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
    collection_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    collection: Option<&'b solana_account_info::AccountInfo<'a>>,
    collection_master_edition_account: Option<&'b solana_account_info::AccountInfo<'a>>,
    collection_authority_record: Option<&'b solana_account_info::AccountInfo<'a>>,
