...
pub const DEPRECATED_CREATE_MASTER_EDITION_DISCRIMINATOR: u8 = 2;
...
impl DeprecatedCreateMasterEdition {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&DeprecatedCreateMasterEditionInstructionData::new()).unwrap();
...
impl Default for DeprecatedCreateMasterEditionInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct DeprecatedCreateMasterEditionBuilder {
    ...
    one_time_printing_authorization_mint: Option<solana_pubkey::Pubkey>,
    update_authority: Option<solana_pubkey::Pubkey>,
    printing_mint_authority: Option<solana_pubkey::Pubkey>,
    ...
    one_time_printing_authorization_mint_authority: Option<solana_pubkey::Pubkey>,
...
impl DeprecatedCreateMasterEditionBuilder {
    ...
    pub fn one_time_printing_authorization_mint(
        &mut self,
        one_time_printing_authorization_mint: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn printing_mint_authority(
        &mut self,
        printing_mint_authority: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn one_time_printing_authorization_mint_authority(
        &mut self,
        one_time_printing_authorization_mint_authority: solana_pubkey::Pubkey,
    ) -> &mut Self {
        self.one_time_printing_authorization_mint_authority =
...
pub struct DeprecatedCreateMasterEditionCpiAccounts<'a, 'b> {
    ...
    /// One time authorization printing mint - A mint you control that prints tokens that gives the bearer permission to mint any number of tokens from the printing mint one time via an endpoint with the token-metadata program for your metadata. Also burns the token.
    pub one_time_printing_authorization_mint: &'b solana_account_info::AccountInfo<'a>,
    /// Current Update authority key
    pub update_authority: &'b solana_account_info::AccountInfo<'a>,
    /// Printing mint authority - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY.
    pub printing_mint_authority: &'b solana_account_info::AccountInfo<'a>,
    /// Mint authority on the metadata's mint - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY
    ...
    /// One time authorization printing mint authority - must be provided if using max supply. THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY.
    pub one_time_printing_authorization_mint_authority: &'b solana_account_info::AccountInfo<'a>,
}
...
impl<'a, 'b> DeprecatedCreateMasterEditionCpiBuilder<'a, 'b> {
    ...
    pub fn one_time_printing_authorization_mint(
        &mut self,
        one_time_printing_authorization_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn printing_mint_authority(
        &mut self,
        printing_mint_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn one_time_printing_authorization_mint_authority(
        &mut self,
        one_time_printing_authorization_mint_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction
            .one_time_printing_authorization_mint_authority =
            Some(one_time_printing_authorization_mint_authority);
...
struct DeprecatedCreateMasterEditionCpiBuilderInstruction<'a, 'b> {
    ...
    one_time_printing_authorization_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    update_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
    printing_mint_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
