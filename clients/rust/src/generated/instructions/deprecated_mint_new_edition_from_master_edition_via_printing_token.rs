...
pub const DEPRECATED_MINT_NEW_EDITION_FROM_MASTER_EDITION_VIA_PRINTING_TOKEN_DISCRIMINATOR: u8 = 3;
...
impl Default for DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
impl DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenBuilder {
    ...
    /// Printing Mint of master record edition
    #[inline(always)]
    pub fn printing_mint(&mut self, printing_mint: solana_pubkey::Pubkey) -> &mut Self {
    ...
    /// Edition pda to mark creation - will be checked for pre-existence. (pda of ['metadata', program id, master mint id, edition_number])
    #[inline(always)]
    pub fn edition_marker(&mut self, edition_marker: solana_pubkey::Pubkey) -> &mut Self {
        self.edition_marker = Some(edition_marker);
        self
    }
    /// Burn authority for this token
    #[inline(always)]
    pub fn burn_authority(&mut self, burn_authority: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn master_update_authority(
        &mut self,
        master_update_authority: solana_pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenCpiAccounts<'a, 'b> {
    ...
    /// Printing Mint of master record edition
    pub printing_mint: &'b solana_account_info::AccountInfo<'a>,
    /// Token account containing Printing mint token to be transferred
    pub master_token_account: &'b solana_account_info::AccountInfo<'a>,
    /// Edition pda to mark creation - will be checked for pre-existence. (pda of ['metadata', program id, master mint id, edition_number])
    pub edition_marker: &'b solana_account_info::AccountInfo<'a>,
    /// Burn authority for this token
    pub burn_authority: &'b solana_account_info::AccountInfo<'a>,
    /// payer
    pub payer: &'b solana_account_info::AccountInfo<'a>,
    /// update authority info for new metadata account
    pub master_update_authority: &'b solana_account_info::AccountInfo<'a>,
    /// Master record metadata account
    ...
    /// Reservation List - If present, and you are on this list, you can get an edition number given by your position on the list.
    pub reservation_list: Option<&'b solana_account_info::AccountInfo<'a>>,
}
...
impl<'a, 'b> DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenCpiBuilder<'a, 'b> {
    ...
    pub fn printing_mint(
        &mut self,
        printing_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn edition_marker(
        &mut self,
        edition_marker: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn burn_authority(
        &mut self,
        burn_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn master_update_authority(
        &mut self,
        master_update_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn reservation_list(
        &mut self,
        reservation_list: Option<&'b solana_account_info::AccountInfo<'a>>,
    ) -> &mut Self {
...
struct DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenCpiBuilderInstruction<'a, 'b> {
    ...
    printing_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    master_token_account: Option<&'b solana_account_info::AccountInfo<'a>>,
    edition_marker: Option<&'b solana_account_info::AccountInfo<'a>>,
    burn_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
    payer: Option<&'b solana_account_info::AccountInfo<'a>>,
    master_update_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
