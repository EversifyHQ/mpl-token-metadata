...
pub const CREATE_MASTER_EDITION_DISCRIMINATOR: u8 = 10;
...
impl CreateMasterEdition {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&CreateMasterEditionInstructionData::new()).unwrap();
...
impl Default for CreateMasterEditionInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
