...
pub const CREATE_METADATA_ACCOUNT_V3_DISCRIMINATOR: u8 = 33;
...
pub struct CreateMetadataAccountV3 {
    ...
    pub update_authority: (solana_pubkey::Pubkey, bool),
    /// System program
...
impl Default for CreateMetadataAccountV3InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct CreateMetadataAccountV3Builder {
    ...
    update_authority: Option<(solana_pubkey::Pubkey, bool)>,
...
impl CreateMetadataAccountV3Builder {
    ...
    pub fn update_authority(
        &mut self,
        update_authority: solana_pubkey::Pubkey,
        as_signer: bool,
    ) -> &mut Self {
...
pub struct CreateMetadataAccountV3CpiAccounts<'a, 'b> {
    ...
    /// update authority info
    pub update_authority: (&'b solana_account_info::AccountInfo<'a>, bool),
    /// System program
...
struct CreateMetadataAccountV3CpiBuilderInstruction<'a, 'b> {
    ...
    update_authority: Option<(&'b solana_account_info::AccountInfo<'a>, bool)>,
