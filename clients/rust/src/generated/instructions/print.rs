...
pub const PRINT_DISCRIMINATOR: u8 = 55;
...
pub struct Print {
    ...
    pub master_token_account_owner: (solana_pubkey::Pubkey, bool),
...
impl Print {
    pub fn instruction(&self, args: PrintInstructionArgs) -> solana_instruction::Instruction {
...
impl Default for PrintInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct PrintBuilder {
    edition_metadata: Option<solana_pubkey::Pubkey>,
    edition: Option<solana_pubkey::Pubkey>,
    edition_mint: Option<solana_pubkey::Pubkey>,
    edition_token_account_owner: Option<solana_pubkey::Pubkey>,
    edition_token_account: Option<solana_pubkey::Pubkey>,
    edition_mint_authority: Option<solana_pubkey::Pubkey>,
    edition_token_record: Option<solana_pubkey::Pubkey>,
    master_edition: Option<solana_pubkey::Pubkey>,
    edition_marker_pda: Option<solana_pubkey::Pubkey>,
    payer: Option<solana_pubkey::Pubkey>,
    master_token_account_owner: Option<(solana_pubkey::Pubkey, bool)>,
    master_token_account: Option<solana_pubkey::Pubkey>,
    master_metadata: Option<solana_pubkey::Pubkey>,
    update_authority: Option<solana_pubkey::Pubkey>,
    spl_token_program: Option<solana_pubkey::Pubkey>,
    spl_ata_program: Option<solana_pubkey::Pubkey>,
...
impl PrintBuilder {
    ...
    /// New Metadata key (pda of ['metadata', program id, mint id])
    #[inline(always)]
    pub fn edition_metadata(&mut self, edition_metadata: solana_pubkey::Pubkey) -> &mut Self {
        self.edition_metadata = Some(edition_metadata);
        self
    }
    /// New Edition (pda of ['metadata', program id, mint id, 'edition'])
    #[inline(always)]
    pub fn edition(&mut self, edition: solana_pubkey::Pubkey) -> &mut Self {
        self.edition = Some(edition);
        self
    }
    /// Mint of new token - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY
    #[inline(always)]
    pub fn edition_mint(&mut self, edition_mint: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn edition_token_account_owner(
        &mut self,
        edition_token_account_owner: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn edition_token_account(
        &mut self,
        edition_token_account: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn edition_mint_authority(
        &mut self,
        edition_mint_authority: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    /// Master Record Edition V2 (pda of ['metadata', program id, master metadata mint id, 'edition'])
    #[inline(always)]
    pub fn master_edition(&mut self, master_edition: solana_pubkey::Pubkey) -> &mut Self {
        self.master_edition = Some(master_edition);
        self
    }
    /// Edition pda to mark creation - will be checked for pre-existence. (pda of ['metadata', program id, master metadata mint id, 'edition', edition_number]) where edition_number is NOT the edition number you pass in args but actually edition_number = floor(edition/EDITION_MARKER_BIT_SIZE).
    #[inline(always)]
    pub fn edition_marker_pda(&mut self, edition_marker_pda: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn master_token_account_owner(
        &mut self,
        master_token_account_owner: solana_pubkey::Pubkey,
        as_signer: bool,
    ) -> &mut Self {
    ...
    pub fn master_token_account(
        &mut self,
        master_token_account: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    /// Master record metadata account
    #[inline(always)]
    pub fn master_metadata(&mut self, master_metadata: solana_pubkey::Pubkey) -> &mut Self {
    ...
    /// SPL Associated Token Account program
    #[inline(always)]
    pub fn spl_ata_program(&mut self, spl_ata_program: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = Print {
            ...
            spl_ata_program: self.spl_ata_program.unwrap_or(solana_pubkey::pubkey!(
...
pub struct PrintCpiAccounts<'a, 'b> {
    /// New Metadata key (pda of ['metadata', program id, mint id])
    pub edition_metadata: &'b solana_account_info::AccountInfo<'a>,
    /// New Edition (pda of ['metadata', program id, mint id, 'edition'])
    pub edition: &'b solana_account_info::AccountInfo<'a>,
    /// Mint of new token - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY
    pub edition_mint: &'b solana_account_info::AccountInfo<'a>,
    /// Owner of the token account of new token
    pub edition_token_account_owner: &'b solana_account_info::AccountInfo<'a>,
    /// Token account of new token
    pub edition_token_account: &'b solana_account_info::AccountInfo<'a>,
    /// Mint authority of new mint
    pub edition_mint_authority: &'b solana_account_info::AccountInfo<'a>,
    /// Token record account
    pub edition_token_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Master Record Edition V2 (pda of ['metadata', program id, master metadata mint id, 'edition'])
    pub master_edition: &'b solana_account_info::AccountInfo<'a>,
    /// Edition pda to mark creation - will be checked for pre-existence. (pda of ['metadata', program id, master metadata mint id, 'edition', edition_number]) where edition_number is NOT the edition number you pass in args but actually edition_number = floor(edition/EDITION_MARKER_BIT_SIZE).
    pub edition_marker_pda: &'b solana_account_info::AccountInfo<'a>,
    /// payer
    pub payer: &'b solana_account_info::AccountInfo<'a>,
    /// owner of token account containing master token
    pub master_token_account_owner: (&'b solana_account_info::AccountInfo<'a>, bool),
    /// token account containing token from master metadata mint
    pub master_token_account: &'b solana_account_info::AccountInfo<'a>,
    /// Master record metadata account
    pub master_metadata: &'b solana_account_info::AccountInfo<'a>,
    /// The update authority of the master edition.
    pub update_authority: &'b solana_account_info::AccountInfo<'a>,
    /// Token program
    pub spl_token_program: &'b solana_account_info::AccountInfo<'a>,
    /// SPL Associated Token Account program
    pub spl_ata_program: &'b solana_account_info::AccountInfo<'a>,
    /// Instructions sysvar account
...
impl<'a, 'b> PrintCpiBuilder<'a, 'b> {
    ...
    pub fn edition_metadata(
        &mut self,
        edition_metadata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn edition_mint(
        &mut self,
        edition_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn edition_token_account_owner(
        &mut self,
        edition_token_account_owner: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn edition_token_account(
        &mut self,
        edition_token_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn edition_mint_authority(
        &mut self,
        edition_mint_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn edition_token_record(
        &mut self,
        edition_token_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    ) -> &mut Self {
    ...
    pub fn master_edition(
        &mut self,
        master_edition: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn edition_marker_pda(
        &mut self,
        edition_marker_pda: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn master_token_account_owner(
        &mut self,
        master_token_account_owner: &'b solana_account_info::AccountInfo<'a>,
        as_signer: bool,
    ) -> &mut Self {
    ...
    pub fn master_token_account(
        &mut self,
        master_token_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn master_metadata(
        &mut self,
        master_metadata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn spl_ata_program(
        &mut self,
        spl_ata_program: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct PrintCpiBuilderInstruction<'a, 'b> {
    ...
    edition_metadata: Option<&'b solana_account_info::AccountInfo<'a>>,
    edition: Option<&'b solana_account_info::AccountInfo<'a>>,
    edition_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    edition_token_account_owner: Option<&'b solana_account_info::AccountInfo<'a>>,
    edition_token_account: Option<&'b solana_account_info::AccountInfo<'a>>,
    edition_mint_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
    edition_token_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    master_edition: Option<&'b solana_account_info::AccountInfo<'a>>,
    edition_marker_pda: Option<&'b solana_account_info::AccountInfo<'a>>,
    payer: Option<&'b solana_account_info::AccountInfo<'a>>,
    master_token_account_owner: Option<(&'b solana_account_info::AccountInfo<'a>, bool)>,
    master_token_account: Option<&'b solana_account_info::AccountInfo<'a>>,
    master_metadata: Option<&'b solana_account_info::AccountInfo<'a>>,
    update_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
    spl_token_program: Option<&'b solana_account_info::AccountInfo<'a>>,
    spl_ata_program: Option<&'b solana_account_info::AccountInfo<'a>>,
