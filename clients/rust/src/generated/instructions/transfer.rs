...
pub const TRANSFER_DISCRIMINATOR: u8 = 49;
...
pub struct TransferBuilder {
    ...
    owner_token_record: Option<solana_pubkey::Pubkey>,
    destination_token_record: Option<solana_pubkey::Pubkey>,
...
pub struct TransferCpiAccounts<'a, 'b> {
    ...
    /// Owner token record account
    pub owner_token_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Destination token record account
    pub destination_token_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Transfer authority (token owner or delegate)
...
impl<'a, 'b> TransferCpiBuilder<'a, 'b> {
    ...
    pub fn destination_owner(
        &mut self,
        destination_owner: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn owner_token_record(
        &mut self,
        owner_token_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    ) -> &mut Self {
    ...
    pub fn destination_token_record(
        &mut self,
        destination_token_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    ) -> &mut Self {
