...
pub const UPDATE_PRIMARY_SALE_HAPPENED_VIA_TOKEN_DISCRIMINATOR: u8 = 4;
...
impl UpdatePrimarySaleHappenedViaToken {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&UpdatePrimarySaleHappenedViaTokenInstructionData::new()).unwrap();
...
impl Default for UpdatePrimarySaleHappenedViaTokenInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
