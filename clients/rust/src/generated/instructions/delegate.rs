...
pub const DELEGATE_DISCRIMINATOR: u8 = 44;
...
impl Delegate {
    pub fn instruction(&self, args: DelegateInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(delegate_record) = self.delegate_record {
            accounts.push(solana_instruction::AccountMeta::new(delegate_record, false));
        } else {
        ...
        if let Some(token) = self.token {
            accounts.push(solana_instruction::AccountMeta::new(token, false));
        } else {
            accounts.push(solana_instruction::AccountMeta::new_readonly(
                crate::TOKEN_METADATA_ID,
                false,
...
impl DelegateBuilder {
    ...
    /// Token account of mint
    #[inline(always)]
    pub fn token(&mut self, token: Option<solana_pubkey::Pubkey>) -> &mut Self {
        self.token = token;
        self
    }
    /// Update authority or token owner
...
pub struct DelegateCpiAccounts<'a, 'b> {
    ...
    /// Token account of mint
    pub token: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Update authority or token owner
    ...
    /// SPL Token Program
    pub spl_token_program: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Token Authorization Rules Program
...
impl<'a, 'b> DelegateCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        if let Some(token) = self.token {
            accounts.push(solana_instruction::AccountMeta::new(*token.key, false));
        } else {
            accounts.push(solana_instruction::AccountMeta::new_readonly(
                crate::TOKEN_METADATA_ID,
                false,
...
impl<'a, 'b> DelegateCpiBuilder<'a, 'b> {
    ...
    /// Token account of mint
    #[inline(always)]
    pub fn token(&mut self, token: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
