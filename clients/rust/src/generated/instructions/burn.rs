...
pub const BURN_DISCRIMINATOR: u8 = 41;
...
impl Burn {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(edition_marker) = self.edition_marker {
            accounts.push(solana_instruction::AccountMeta::new(edition_marker, false));
        } else {
            accounts.push(solana_instruction::AccountMeta::new_readonly(
                crate::TOKEN_METADATA_ID,
                false,
...
pub struct BurnBuilder {
    ...
    collection_metadata: Option<solana_pubkey::Pubkey>,
    ...
    master_edition_token: Option<solana_pubkey::Pubkey>,
...
impl BurnBuilder {
    ...
    /// Edition of the asset
    #[inline(always)]
    pub fn edition(&mut self, edition: Option<solana_pubkey::Pubkey>) -> &mut Self {
    ...
    /// Edition marker account
    #[inline(always)]
    pub fn edition_marker(&mut self, edition_marker: Option<solana_pubkey::Pubkey>) -> &mut Self {
...
pub struct BurnCpiAccounts<'a, 'b> {
    ...
    /// Metadata of the Collection
    pub collection_metadata: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Metadata (pda of ['metadata', program id, mint id])
    ...
    /// Master edition mint of the asset
    pub master_edition_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Master edition token account
    pub master_edition_token: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Edition marker account
    pub edition_marker: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Token record account
...
impl<'a, 'b> BurnCpiBuilder<'a, 'b> {
    ...
    pub fn collection_metadata(
        &mut self,
        collection_metadata: Option<&'b solana_account_info::AccountInfo<'a>>,
    ) -> &mut Self {
    ...
    pub fn master_edition_token(
        &mut self,
        master_edition_token: Option<&'b solana_account_info::AccountInfo<'a>>,
    ) -> &mut Self {
