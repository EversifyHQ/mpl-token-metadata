...
pub const DEPRECATED_CREATE_RESERVATION_LIST_DISCRIMINATOR: u8 = 6;
...
impl DeprecatedCreateReservationList {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&DeprecatedCreateReservationListInstructionData::new()).unwrap();
...
pub struct DeprecatedCreateReservationListInstructionData {
    discriminator: u8,
}

impl DeprecatedCreateReservationListInstructionData {
    pub fn new() -> Self {
        Self { discriminator: 6 }
    }
}

impl Default for DeprecatedCreateReservationListInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `DeprecatedCreateReservationList`.
///
/// ### Accounts:
///
...
pub struct DeprecatedCreateReservationListBuilder {
...
impl DeprecatedCreateReservationListBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// PDA for ReservationList of ['metadata', program id, master edition key, 'reservation', resource-key]
    #[inline(always)]
    pub fn reservation_list(&mut self, reservation_list: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = DeprecatedCreateReservationList {
...
/// `deprecated_create_reservation_list` CPI accounts.
pub struct DeprecatedCreateReservationListCpiAccounts<'a, 'b> {
    /// PDA for ReservationList of ['metadata', program id, master edition key, 'reservation', resource-key]
    pub reservation_list: &'b solana_account_info::AccountInfo<'a>,
    /// Payer
...
/// `deprecated_create_reservation_list` CPI instruction.
pub struct DeprecatedCreateReservationListCpi<'a, 'b> {
...
impl<'a, 'b> DeprecatedCreateReservationListCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: DeprecatedCreateReservationListCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DeprecatedCreateReservationList` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` reservation_list
...
///   7. `[]` rent
#[derive(Clone, Debug)]
pub struct DeprecatedCreateReservationListCpiBuilder<'a, 'b> {
    instruction: Box<DeprecatedCreateReservationListCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DeprecatedCreateReservationListCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DeprecatedCreateReservationListCpiBuilderInstruction {
            __program: program,
    ...
    pub fn reservation_list(
        &mut self,
        reservation_list: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = DeprecatedCreateReservationListCpi {
...
#[derive(Clone, Debug)]
struct DeprecatedCreateReservationListCpiBuilderInstruction<'a, 'b> {
