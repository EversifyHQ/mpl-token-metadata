...
pub const APPROVE_USE_AUTHORITY_DISCRIMINATOR: u8 = 20;
...
impl Default for ApproveUseAuthorityInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct ApproveUseAuthorityBuilder {
    use_authority_record: Option<solana_pubkey::Pubkey>,
    owner: Option<solana_pubkey::Pubkey>,
    payer: Option<solana_pubkey::Pubkey>,
    user: Option<solana_pubkey::Pubkey>,
    owner_token_account: Option<solana_pubkey::Pubkey>,
    metadata: Option<solana_pubkey::Pubkey>,
    mint: Option<solana_pubkey::Pubkey>,
    burner: Option<solana_pubkey::Pubkey>,
...
impl ApproveUseAuthorityBuilder {
    ...
    pub fn use_authority_record(
        &mut self,
        use_authority_record: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    /// Owned Token Account Of Mint
    #[inline(always)]
    pub fn owner_token_account(&mut self, owner_token_account: solana_pubkey::Pubkey) -> &mut Self {
    ...
    /// Program As Signer (Burner)
    #[inline(always)]
    pub fn burner(&mut self, burner: solana_pubkey::Pubkey) -> &mut Self {
...
pub struct ApproveUseAuthorityCpiAccounts<'a, 'b> {
    /// Use Authority Record PDA
    pub use_authority_record: &'b solana_account_info::AccountInfo<'a>,
    /// Owner
...
impl<'a, 'b> ApproveUseAuthorityCpiBuilder<'a, 'b> {
    ...
    pub fn use_authority_record(
        &mut self,
        use_authority_record: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct ApproveUseAuthorityCpiBuilderInstruction<'a, 'b> {
    ...
    use_authority_record: Option<&'b solana_account_info::AccountInfo<'a>>,
