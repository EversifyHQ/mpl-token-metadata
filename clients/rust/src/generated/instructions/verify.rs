...
pub const VERIFY_DISCRIMINATOR: u8 = 52;
...
pub struct VerifyBuilder {
    ...
    collection_master_edition: Option<solana_pubkey::Pubkey>,
...
impl VerifyBuilder {
    ...
    /// Mint of the Collection
    #[inline(always)]
    pub fn collection_mint(&mut self, collection_mint: Option<solana_pubkey::Pubkey>) -> &mut Self {
...
pub struct VerifyCpiAccounts<'a, 'b> {
    ...
    /// Mint of the Collection
    pub collection_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Metadata Account of the Collection
    pub collection_metadata: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Master Edition Account of the Collection Token
    pub collection_master_edition: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// System program
...
impl<'a, 'b> VerifyCpiBuilder<'a, 'b> {
    ...
    pub fn collection_master_edition(
        &mut self,
        collection_master_edition: Option<&'b solana_account_info::AccountInfo<'a>>,
    ) -> &mut Self {
