...
pub const DEPRECATED_SET_RESERVATION_LIST_DISCRIMINATOR: u8 = 5;
...
impl DeprecatedSetReservationList {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&DeprecatedSetReservationListInstructionData::new()).unwrap();
...
impl Default for DeprecatedSetReservationListInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
