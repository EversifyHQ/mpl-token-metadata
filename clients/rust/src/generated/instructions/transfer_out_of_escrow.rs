...
pub const TRANSFER_OUT_OF_ESCROW_DISCRIMINATOR: u8 = 40;
...
impl Default for TransferOutOfEscrowInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct TransferOutOfEscrowBuilder {
    ...
    attribute_mint: Option<solana_pubkey::Pubkey>,
    attribute_src: Option<solana_pubkey::Pubkey>,
    attribute_dst: Option<solana_pubkey::Pubkey>,
    escrow_mint: Option<solana_pubkey::Pubkey>,
...
impl TransferOutOfEscrowBuilder {
    ...
    /// Mint account for the new attribute
    #[inline(always)]
    pub fn attribute_mint(&mut self, attribute_mint: solana_pubkey::Pubkey) -> &mut Self {
        self.attribute_mint = Some(attribute_mint);
        self
    }
    /// Token account source for the new attribute
    #[inline(always)]
    pub fn attribute_src(&mut self, attribute_src: solana_pubkey::Pubkey) -> &mut Self {
        self.attribute_src = Some(attribute_src);
        self
    }
    /// Token account, owned by TM, destination for the new attribute
    #[inline(always)]
    pub fn attribute_dst(&mut self, attribute_dst: solana_pubkey::Pubkey) -> &mut Self {
        self.attribute_dst = Some(attribute_dst);
        self
    }
    /// Mint account that the escrow is attached
    #[inline(always)]
    pub fn escrow_mint(&mut self, escrow_mint: solana_pubkey::Pubkey) -> &mut Self {
...
pub struct TransferOutOfEscrowCpiAccounts<'a, 'b> {
    ...
    /// Mint account for the new attribute
    pub attribute_mint: &'b solana_account_info::AccountInfo<'a>,
    /// Token account source for the new attribute
    pub attribute_src: &'b solana_account_info::AccountInfo<'a>,
    /// Token account, owned by TM, destination for the new attribute
    pub attribute_dst: &'b solana_account_info::AccountInfo<'a>,
    /// Mint account that the escrow is attached
    pub escrow_mint: &'b solana_account_info::AccountInfo<'a>,
    /// Token account that holds the token the escrow is attached to
...
impl<'a, 'b> TransferOutOfEscrowCpiBuilder<'a, 'b> {
    ...
    pub fn attribute_mint(
        &mut self,
        attribute_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn attribute_src(
        &mut self,
        attribute_src: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn attribute_dst(
        &mut self,
        attribute_dst: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn escrow_mint(
        &mut self,
        escrow_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct TransferOutOfEscrowCpiBuilderInstruction<'a, 'b> {
    ...
    attribute_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    attribute_src: Option<&'b solana_account_info::AccountInfo<'a>>,
    attribute_dst: Option<&'b solana_account_info::AccountInfo<'a>>,
    escrow_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
