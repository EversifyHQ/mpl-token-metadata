...
pub const UPDATE_METADATA_ACCOUNT_DISCRIMINATOR: u8 = 1;
...
impl UpdateMetadataAccount {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&UpdateMetadataAccountInstructionData::new()).unwrap();
...
impl Default for UpdateMetadataAccountInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
