...
pub const UTILIZE_DISCRIMINATOR: u8 = 19;
...
impl Utilize {
    pub fn instruction(&self, args: UtilizeInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(burner) = self.burner {
            accounts.push(solana_instruction::AccountMeta::new_readonly(burner, false));
        }
...
impl Default for UtilizeInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct UtilizeBuilder {
    ...
    use_authority: Option<solana_pubkey::Pubkey>,
...
impl UtilizeBuilder {
    ...
    /// A Use Authority / Can be the current Owner of the NFT
    #[inline(always)]
    pub fn use_authority(&mut self, use_authority: solana_pubkey::Pubkey) -> &mut Self {
    ...
    /// Program As Signer (Burner)
    #[inline(always)]
    pub fn burner(&mut self, burner: Option<solana_pubkey::Pubkey>) -> &mut Self {
        self.burner = burner;
        self
    }
    #[inline(always)]
...
pub struct UtilizeCpiAccounts<'a, 'b> {
    ...
    /// A Use Authority / Can be the current Owner of the NFT
    pub use_authority: &'b solana_account_info::AccountInfo<'a>,
    /// Owner
    ...
    /// Use Authority Record PDA If present the program Assumes a delegated use authority
    pub use_authority_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// Program As Signer (Burner)
    pub burner: Option<&'b solana_account_info::AccountInfo<'a>>,
}
...
impl<'a, 'b> UtilizeCpiBuilder<'a, 'b> {
    ...
    pub fn use_authority(
        &mut self,
        use_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct UtilizeCpiBuilderInstruction<'a, 'b> {
    ...
    use_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
