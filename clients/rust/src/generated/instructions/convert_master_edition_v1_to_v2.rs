...
pub const CONVERT_MASTER_EDITION_V1_TO_V2_DISCRIMINATOR: u8 = 12;
...
impl Default for ConvertMasterEditionV1ToV2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct ConvertMasterEditionV1ToV2Builder {
    ...
    one_time_auth: Option<solana_pubkey::Pubkey>,
...
impl ConvertMasterEditionV1ToV2Builder {
    ...
    /// One time authorization mint
    #[inline(always)]
    pub fn one_time_auth(&mut self, one_time_auth: solana_pubkey::Pubkey) -> &mut Self {
...
pub struct ConvertMasterEditionV1ToV2CpiAccounts<'a, 'b> {
    ...
    /// One time authorization mint
    pub one_time_auth: &'b solana_account_info::AccountInfo<'a>,
    /// Printing mint
...
impl<'a, 'b> ConvertMasterEditionV1ToV2CpiBuilder<'a, 'b> {
    ...
    pub fn one_time_auth(
        &mut self,
        one_time_auth: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct ConvertMasterEditionV1ToV2CpiBuilderInstruction<'a, 'b> {
    ...
    one_time_auth: Option<&'b solana_account_info::AccountInfo<'a>>,
