...
pub const APPROVE_COLLECTION_AUTHORITY_DISCRIMINATOR: u8 = 23;
...
impl Default for ApproveCollectionAuthorityInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct ApproveCollectionAuthorityBuilder {
    ...
    new_collection_authority: Option<solana_pubkey::Pubkey>,
...
impl ApproveCollectionAuthorityBuilder {
    ...
    pub fn new_collection_authority(
        &mut self,
        new_collection_authority: solana_pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct ApproveCollectionAuthorityCpiAccounts<'a, 'b> {
    ...
    /// A Collection Authority
    pub new_collection_authority: &'b solana_account_info::AccountInfo<'a>,
    /// Update Authority of Collection NFT
...
impl<'a, 'b> ApproveCollectionAuthorityCpiBuilder<'a, 'b> {
    ...
    pub fn new_collection_authority(
        &mut self,
        new_collection_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct ApproveCollectionAuthorityCpiBuilderInstruction<'a, 'b> {
    ...
    new_collection_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
