...
pub const DEPRECATED_MINT_PRINTING_TOKENS_DISCRIMINATOR: u8 = 9;
...
impl DeprecatedMintPrintingTokens {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&DeprecatedMintPrintingTokensInstructionData::new()).unwrap();
...
impl Default for DeprecatedMintPrintingTokensInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
